...
- (id)init {
    if ((self = [super init]))  {
        // Load close buttons 
        _closeButton = [NSImage imageNamed:@"TabClose_Front"];
        _closeButtonDown = [NSImage imageNamed:@"TabClose_Front_Pressed"];
        _closeButtonOver = [NSImage imageNamed:@"TabClose_Front_Rollover"];
