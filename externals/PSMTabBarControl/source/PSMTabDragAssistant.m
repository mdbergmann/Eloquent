...
//    [[cell indicator] removeFromSuperview];
    ...
    imageToDrag = [[NSImage alloc] initWithSize:NSMakeSize(1, 1)];
...
- (void)distributePlaceholdersInTabBar:(PSMTabBarControl *)control
{
    ...
    for(i = 0; i < numVisibleTabs; i++) {
        PSMTabBarCell *pc = [[PSMTabBarCell alloc] initPlaceholderWithFrame:draggedCellFrame expanded:NO inControlView:control];
